...
def propagate(w, b, X, Y):
    ...
    Y -- true "label" vector (containing 0 if non-cat, 1 if cat) of size (1, number of examples), a numpy array of size (1,num of examples)
...
def model(X_train, Y_train, X_test, Y_test, num_iterations = 2000, learning_rate = 0.5, print_cost = False):
    ...
    parameters, grads, costs = optimize(b=b,w=w,X=X_train,Y=Y_train,
